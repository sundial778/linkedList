...
class Tracks {
    constructor(json) {
        ...
        this.votes = 0;
        this.images = json.album.images[0].url;
...
class Artist {
    constructor(json,i) {
        ...
        this.id = json.artists.items[i].id;
        this.Artist = json.artists.items[i].name;
        this.Albums = [];
        this.image = json.artists.items[i].images[i].url;
    }
}

$(document).ready(function () {

    const url = 'https://api.spotify.com/v1/search/?q=[ARG1]&type=[ARG2]&limit=5'
    ...
    function makeItUseable(text) {
        ...
        objArr.forEach(function (data) {
            search(data.searchString,"track,artist")
        });
    }
        ...
        xhr.onreadystatechange = function (e) {
            if (this.readyState === 4) {
                ...
                if (this.status === 200) {
                    ...
                    restPonse.tracks.items.forEach(function (amt) {
